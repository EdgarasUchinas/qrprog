...
def main():
    ...
    print(full_path)
    print(Config.QR_CODE_IMAGE_DIRECTORY)
    print(Config.QR_CODE_IMAGE_FILE_NAME)

    directory_path_and_file_name = os.path.join(full_path, Config.QR_CODE_IMAGE_DIRECTORY, Config.QR_CODE_IMAGE_FILE_NAME)


    print(directory_path_and_file_name)
